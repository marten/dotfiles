...
you should place your code here."
  ;; (spacemacs/set-leader-keys "o," 'spacemacs/alternate-buffer)
  ;; (spacemacs/set-leader-keys "o/" 'evil-search-clear-highlight)
  (global-evil-mc-mode)
  (global-set-key (kbd "s-d") 'evil-mc-make-and-goto-next-match)
  ;; (global-set-key (kbd "Q") 'evil-fill-and-move)
